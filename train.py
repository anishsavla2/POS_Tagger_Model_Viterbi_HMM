...
def parse_traindata():
    fin = "train_data/new_train_data.txt"
...
def transition_probability(train_data):
    ...
    for key in count_dict:
        ...
        prob_dict[key] = Decimal(count_dict[key]+1)/(den)
    return prob_dict
...
def transition_smoothing(train_data):
    ...
    #print("Transition probability is : ",type(transition_prob))

   # print("Transition probability is : ", sorted_d)
...
def emission_probability(train_data):
    ...
    for key in word_count:
        emission_prob_dict[key] = Decimal(word_count[key]+1)/tag_count[key.split("/")[-1]]
