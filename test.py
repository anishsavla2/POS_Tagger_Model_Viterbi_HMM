...
def viterbi_algorithm(sentence, tag_list, transition_prob, emission_prob,tag_count, word_set):
    ...
    #print("Tag count is : ",tag_count)
    #print("Word set is : ",word_set)
    global tag_set
    ...
    for tag in tag_list:
        ...
        #print("Test 1 : ", word_list[0].lower())
...
#predicted = open("test_data/new_Dev_data_training.txt", "r")
predicted = codecs.open("outputs/hmmoutput.txt", mode ='r', encoding="utf-8")
expected = codecs.open("test_data/new_Dev_data_training.txt", mode ='r', encoding="utf-8")

c = 0
total = 0
#print("Test 4")
#print("Predicted output is : ",predicted.readlines())
